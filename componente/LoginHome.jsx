        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4 flex items-center justify-between">
            ...
            <button
              ...
              onClick={() => {router.push("/");
              router.refresh();}}
              className="inline-flex h-12 cursor-pointer items-center gap-2 rounded-2xl border border-[#014C6D] px-6 text-[#014C6D] hover:bg-[#014C6D]/5"
            >
              <ChevronLeft size={18} />
              Back
            </button>
            ...
            <button
              type="submit"
              disabled={loading}
              className="inline-flex cursor-pointer h-12 items-center gap-2 rounded-2xl bg-[#014C6D] px-8 text-white hover:opacity-90 disabled:opacity-60"
            >
